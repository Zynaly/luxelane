...
# ── Sprint 15: Asynchronous Data Export Job ───────────────────────────────────
...
class ExportJob(BaseModel):
    """
    Tracks asynchronous CSV/JSON export batches generated by platform administrators.
    """
    ...
    def __str__(self):
        return f"ExportJob {self.id} — {self.resource}.{self.format} [{self.status}]"
